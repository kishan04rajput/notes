...
<header>, <nav>, <main>, <section>, <article>, <aside>, <footer>, <div>, <figure>, <figcaption>, <dialog>, <details>, <summary>`,
        ...
        {
            Q: `What is .svg file image in html?`,
            A: `An SVG (Scalable Vector Graphics) file is an image format that uses XML to define the shapes, colors, and paths that make up the image. Unlike raster images (like JPEG or PNG), SVG images are vector-based, which means they can be scaled to any size without losing quality.`,
        },
        {
            Q: `What is Custom data attributes in html?`,
            A: `Custom data attributes, prefixed with data-, are used to store additional information on standard HTML elements, which can be accessed using JavaScript.`,
        },
        // {
        //   Q: ``,
        //   A: ``,
